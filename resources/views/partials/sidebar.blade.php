<aside class="
        bg-gradient-to-r from-emerald-600 to-emerald-700 text-white flex items-center
    ...
    <form action="{{ route('logout') }}" method="POST" class="w-full md:w-auto">
        @csrf
        <button type="submit" class="mt-4 flex items-center justify-center gap-2
                w-full px-7 md:py-3 bg-red-500 hover:bg-red-600 text-white font-semibold
